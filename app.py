...
col1, col2, col3 = st.columns(3)
with col1:
    monday = st.multiselect("Lunes", options= available, placeholder="Todos")
with col2:
    tuesday = st.multiselect("Martes", options=available, placeholder="Todos")
with col3:
    wednesday = st.multiselect("Miércoles", options=available, placeholder="Todos")    
    
col1, col2, col3, col4 = st.columns(4)
with col1:
    thursday = st.multiselect("Jueves", options=available, placeholder="Todos")
with col2:
    friday = st.multiselect("Viernes", options=available, placeholder="Todos")
with col3:
    saturday = st.multiselect("Sábado", options=available, placeholder="Todos")
with col4:
    sunday = st.multiselect("Domingo", options=available, placeholder="Todos")
